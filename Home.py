...
st.set_page_config(
    page_title="Dashboard ENADE 2023",
    page_icon="🎓",
    layout="wide",
    initial_sidebar_state="expanded"
)

# Estilo personalizado para remover margens excessivas do gráfico
st.markdown("""
    <style>
...
# --- 3. ÁREA PRINCIPAL ---
st.title("🎓 Dashboard de Análise Educacional")
st.markdown("### Foco: Incentivo à Escolha do Curso (QE_I19)")
